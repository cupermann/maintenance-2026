...
use App\Filament\Admin\Resources\TeknisiResource\Api\Requests\UpdateTeknisiRequest;
...
class UpdateHandler extends Handlers {
     ...
     * Update Teknisi
     *
     * @param UpdateTeknisiRequest $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function handler(UpdateTeknisiRequest $request)
    {
        $id = $request->route('id');
